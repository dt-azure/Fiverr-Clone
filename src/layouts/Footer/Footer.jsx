...
const Footer = () => {
  return (
    <footer className="footer">
      <div className="main-container footer-wrapper">
          ...
          <div className="footer-grid-item">
            ...
            <ul>
              ...
              <li>
                <a href="/">
                  Learn
                  <br /> <span className="text-xs italic">Online Coursers</span>
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul>
              ...
              <li>
                <a href="/">
                  ClearVoice
                  <br />{" "}
                  <span className="text-xs italic">Content Marketing</span>
                </a>
              </li>
              <li>
        ...
        <div className="bottom flex justify-between">
          ...
          <div className="right flex">
            <ul className="socials flex items-center gap-6">
              <li>
                <a href="/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="settings flex items-center gap-4 ml-8">
